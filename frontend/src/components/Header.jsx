...
import { clearWishlist, updateWishlist } from "../features/wishlist/wishlistSlice.js";
...
const Header = () => {
  ...
  const toggleTheme = () => {
    setTheme(theme === 'luxury' ? 'wireframe' : 'luxury');
  };
  React.useEffect(() => {
  ...
  const fetchWishlist = async () => {
    if(loginState){
      try {
        const getResponse = await axios.get(`http://localhost:8080/user/getuser/${localStorage.getItem("id")}`);
        ...
        <div className="drawer">
          ...
          <div className="drawer-side z-10">
            ...
            <FaWindowClose className="text-3xl ml-auto" />
              ...
              <li className="text-xl">
                <NavLink className="text-accent-content" to="/chat">
                  Chat
                </NavLink>
              </li>
              {!isLoggedIn && (
